...
# --------------------------------------------------------------------
# File Name          : flat_cat_slots_full_state_bert_snt_pair_match_model.py
...
class FlatCatSlotsFullStateBERTSntPairMatchModel(PreTrainedModel, EncodeUttSchemaPairInterface, FlatDSTOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None):
        super(FlatCatSlotsFullStateBERTSntPairMatchModel, self).__init__(config=config)
    ...
    def _get_categorical_slots_goals(self, features, is_training):
        ...
        return masked_cat_slot_value_logits
    ...
    def forward(self, features, labels=None):
        ...
        outputs = {}
        cat_slot_value_logits = self._get_categorical_slots_goals(features, is_training)
        outputs["logit_cat_slot_value_full_state"] = cat_slot_value_logits
