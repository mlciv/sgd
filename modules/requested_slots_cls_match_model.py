...
class RequestedSlotsCLSMatchModel(PreTrainedModel, DSTC8BaselineOutputInterface):
    """
    ...
    def __init__(self, encoder=None, config=None, args=None):
        super(RequestedSlotsCLSMatchModel, self).__init__(config=config)
        ...
        if encoder:
            ...
            EncoderUtils.set_encoder_finetuning_status(self.encoder, args.encoder_fintuning)
    ...
    def _get_requested_slots(self, features, _encoded_utterance, is_training):
        """Obtain logits for requested slots."""
        slot_embeddings, _ = self._encode_schema(features, "req_slot", is_training)
    ...
    def forward(self, features, labels=None):
        ...
        outputs = {}
        outputs["logit_req_slot_status"] = self._get_requested_slots(features, _encoded_utterance, is_training)
