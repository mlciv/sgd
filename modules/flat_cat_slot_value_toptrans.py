...
class FlatCatSlotValueTopTransModel(PreTrainedModel, EncodeSepUttSchemaInterface, FlatDSTOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None, utt_encoder=None, schema_encoder=None):
        super(FlatCatSlotValueTopTransModel, self).__init__(config=config)
