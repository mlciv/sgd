...
class FlatRequestedSlotsTopTrans(PreTrainedModel, EncodeSepUttSchemaInterface, FlatDSTOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None, utt_encoder=None, schema_encoder=None):
        super(FlatRequestedSlotsTopTrans, self).__init__(config=config)
    ...
    def _get_requested_slots(self, features, is_training):
        ...
        logits = self._get_logits(
            ...
            self.requested_slots_matching_layer, self.requested_slots_final_proj, is_training)
        # Shape: (batch_size, 1)
