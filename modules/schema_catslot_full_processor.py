...
class SchemaCatSlotFullProcessor(SchemaDialogProcessor):
    """
    ...
    def __init__(self,
        ...
        super(SchemaCatSlotFullProcessor, self).__init__(
    ...
    def _create_examples_from_turn(self, turn_id, utterances,
        ...
        for service, user_frame in current_user_frames.items():
            ...
            cat_slot_examples = example.add_categorical_slots_full_state(state)
