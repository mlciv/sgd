...
class SchemaIntentProcessor(SchemaDialogProcessor):
    """
    ...
    def __init__(self,
        ...
        self.metrics = evaluate_utils.ACTIVE_INTENT_SUBKEYS
    ...
    def _create_examples_from_turn(self, turn_id, utterances,
        ...
        for service, user_frame in current_user_frames.items():
            ...
            all_intent_examples.extend(intent_examples)

        return all_intent_examples, states
