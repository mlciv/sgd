...
class RequestedSlotsFusionModel(PreTrainedModel, EncodeSepUttSchemaInterface, DSTC8BaselineOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None, utt_encoder=None, schema_encoder=None):
        super(RequestedSlotsFusionModel, self).__init__(config=config)
