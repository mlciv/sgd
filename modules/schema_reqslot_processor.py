...
class SchemaReqSlotProcessor(SchemaDialogProcessor):
    """
    ...
    def __init__(self,
        ...
        super(SchemaReqSlotProcessor, self).__init__(
        ...
        self.metrics = evaluate_utils.REQUESTED_SLOTS_SUBKEYS
    ...
    def _create_examples_from_turn(self, turn_id, utterances,
        ...
        for service, user_frame in current_user_frames.items():
            ...
            all_req_slot_examples.extend(req_slot_examples)

        return all_req_slot_examples, states
