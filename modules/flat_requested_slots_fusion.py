...
# to predict requested slots, flatten examples
# --------------------------------------------------------------------
...
class FlatRequestedSlotsFusionModel(FlatRequestedSlotsTopTrans, FixedSchemaCacheEncoder):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None, utt_encoder=None, schema_encoder=None):
        super(FlatRequestedSlotsFusionModel, self).__init__(config=config, args=args, utt_encoder=utt_encoder, schema_encoder=None)
