...
# --------------------------------------------------------------------
# File Name          : requested_slots_bert_snt_pair_match_model.py
...
class RequestedSlotsBERTSntPairMatchModel(PreTrainedModel, EncodeUttSchemaPairInterface, DSTC8BaselineOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None):
        super(RequestedSlotsBERTSntPairMatchModel, self).__init__(config=config)
    ...
    def _get_requested_slots(self, features, is_training):
        ...
        utt_intent_pair_cls, _ = self._encode_utterance_schema_pairs(
