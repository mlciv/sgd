...
class FlatCatSlotValueBERTSntPairMatchModel(PreTrainedModel, EncodeUttSchemaPairInterface, FlatDSTOutputInterface):
    """
    ...
    def __init__(self, config=None, args=None, encoder=None):
        super(FlatCatSlotValueBERTSntPairMatchModel, self).__init__(config=config)
