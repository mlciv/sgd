...
MODEL_TYPE=active_intent_bert_snt_pair_match
# encoder config name for the task
ENCODER_CONFIG_NAME=
# encoder_model_name_path, whether a name or a path for the model
ENCODER_MODEL_NAME_PATH=$SGD_JSON_CONFIG_DIR/encoders/roberta-large.json
# config name for the task
CONFIG_NAME=$SGD_JSON_CONFIG_DIR/models/active_intent_bert_snt_pair_match.json
