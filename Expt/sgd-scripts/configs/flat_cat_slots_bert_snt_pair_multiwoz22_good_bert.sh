...
MODEL_TYPE=flat_cat_slots_bert_snt_pair_match
...
CONFIG_NAME=$SGD_JSON_CONFIG_DIR/models/flat_cat_slots_bert_snt_pair_match.json
...
DATA_DIR=$MULTIWOZ22_GOOD_DATA_DIR
