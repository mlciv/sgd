...
echo $EXP_NAME
TASK_NAME=dstc8_back_translation
...
MODEL_TYPE=flat_requested_slots_bert_snt_pair_match
...
CONFIG_NAME=$SGD_JSON_CONFIG_DIR/models/flat_requested_slots_bert_snt_pair_match_desc_only.json
