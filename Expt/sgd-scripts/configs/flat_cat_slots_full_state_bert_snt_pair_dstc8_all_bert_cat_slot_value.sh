...
MODEL_TYPE=flat_cat_slots_full_state_bert_snt_pair_match
...
CONFIG_NAME=$SGD_JSON_CONFIG_DIR/models/flat_cat_slots_full_state_bert_snt_pair_match_cat_slot_value.json
