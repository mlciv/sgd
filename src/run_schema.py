...
from modules.schema_dstc8_processor import SchemaDSTC8Processor
...
MODEL_CLASSES = {
    # baseline cls based
    "dstc8baseline": (DSTC8BaselineModel, SchemaDSTC8Processor),
    "active_intent_cls_match": (ActiveIntentCLSMatchModel, SchemaDSTC8Processor),
    "requested_slots_cls_match": (RequestedSlotsCLSMatchModel, SchemaDSTC8Processor),
    "cat_slots_cls_match": (CatSlotsCLSMatchModel, SchemaDSTC8Processor),
    "noncat_slots_cls_match": (NonCatSlotsCLSMatchModel, SchemaDSTC8Processor),
    ...
    "requested_slots_bert_snt_pair_match": (RequestedSlotsBERTSntPairMatchModel, SchemaDialogProcessor),
    "cat_slots_bert_snt_pair_match": (CatSlotsBERTSntPairMatchModel, SchemaDialogProcessor),
    "noncat_slots_bert_snt_pair_match": (NonCatSlotsBERTSntPairMatchModel, SchemaDialogProcessor),
    # flatten shuffle dataset
    "flat_active_intent_bert_snt_pair_match": (ActiveIntentBERTSntPairMatchModel, SchemaIntentProcessor),
    "flat_requested_slots_bert_snt_pair_match": (RequestedSlotsBERTSntPairMatchModel, SchemaReqSlotProcessor),
    "flat_cat_slots_bert_snt_pair_match": (CatSlotsBERTSntPairMatchModel, SchemaCatSlotProcessor),
    "flat_noncat_slots_bert_snt_pair_match": (NonCatSlotsBERTSntPairMatchModel, SchemaCatSlotProcessor)
    }
...
def train(args, config, train_dataset, model, processor):
    ...
    if args.model_type in MODEL_CLASSES.keys():
